...
tabla_resumen <- data.frame(
  Métrica = c("Total Productos", "Media", "Mediana", "Moda", "Desviación Estándar", "Mínimo", "Máximo"),
...
resumen_d %>%
  kable(col.names = c("Rango de Descuento", "Productos", "Media", "Mediana", "Moda", "D.E."),
        caption = "Análisis de Satisfacción por Intervalos de Descuento (20%)",
        align = "lccccc") %>%
...
ggplot(df_sin_atipicos, aes(x = rango_descuento, y = rating, fill = rango_descuento)) +
  ...
  labs(title = "Distribución del Rating por Intervalos de Descuento",
       subtitle = "Evaluación de la indulgencia del consumidor en rangos del 20%",
