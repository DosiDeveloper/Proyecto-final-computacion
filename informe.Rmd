...
\begin{itemize}
  ...
  \item{Cuantificar la relación entre la cantidad de interacción  y el precio final del producto para medir el nivel de participación del usuario según el costo.}
   \item{Identificar la frecuencia de términos asociados a "valor por dinero" en los review_title de productos con calificaciones altas pero descuentos agresivos.}
}
\end{itemize}
